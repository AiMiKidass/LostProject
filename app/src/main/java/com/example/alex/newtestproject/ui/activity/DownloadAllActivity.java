...
public class DownloadAllActivity extends BaseActivity implements XExecutor.OnAllTaskEndListener {
    ...
    private static final String DIRECTORY_DOWNLOAD_PATH = "/aaa/";
    ...
    private ArrayList<ApkModel> apkModels;
    ...
    public void addTasks(View view) {
        download(apkModels.get(0));
        download(apkModels.get(1));
        download(apkModels.get(2));

        adapter.updateData(DownloadAdapter.TYPE_ALL);
    }

    protected ArrayList<ApkModel> initDownloadUrls() {
        ArrayList<ApkModel> apks = new ArrayList<>();
        ...
        apk1.url = "https://www.wandoujia.com/apps/com.tencent.tmgp.pubgmhd/download/dot?ch=detail_normal_dl";
        apks.add(apk1);
