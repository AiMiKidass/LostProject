...
public class XApplication extends Application {
    ...
    private void init() {
         ...
         * 5. 配置Cookie，以下几种任选其一就行
         如果你用到了Cookie的持久化或者叫Session的保持，那么建议配置一个Cookie，这个也是可以自定义的
         ，不一定非要用OkGo自己的
         ，以下三个是OkGo默认提供的三种方式，可以选择添加，也可以自己实现CookieJar的接口
         ，自己管理cookie。
         */
...
//        HttpsUtils.SSLParams sslParams4 = HttpsUtils.getSslSocketFactory(getAssets().open("xxx.bks"), "123456", getAssets().open("yyy.cer"));
        ...
        /**
         * 7. 配置OkGo
         以上代码主要是OkHttpClient的配置，其实和OkGo也没啥关系
         ，你要是使用其他okhttp的框架也得配置，都是一样的，包括你配置其他拦截器什么的
         ，只要okhttp支持的，你都可以加，都是有效的。那么下面的代码才是OkGo特有的配置
         ，在初始化完成后，可以传入我们配置好的OkHttpClient，也可以配置其他参数，详细如下：
         */
...
//-------------------------------------------------------------------------------------//
        ...
        OkGo.getInstance().init(XApplication.this)                       //必须调用初始化
