...
/**
 - @Description:  SharedPreferences 读写操作工具类
 - @Author:  MrZC
 - @Time:  2018/9/28
 */
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = XApplication.getInstance().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = XApplication.getInstance().getSharedPreferences(spName, mode);
    }
