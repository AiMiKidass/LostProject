 ...
 * ================================================
 */
public class DownloadAdapter extends BaseQuickAdapter<DownloadTask,DownloadAdapter.DownloadFinallyViewHolder> {
    ...
    @Override
    protected void convert(DownloadFinallyViewHolder holder, DownloadTask task) {
    ...
    public class DownloadFinallyViewHolder extends BaseViewHolder {
        ...
        public DownloadFinallyViewHolder(View itemView) {
            super(itemView);
    ...
    private class ListDownloadListener extends DownloadListener {
        private DownloadFinallyViewHolder holder;

        ListDownloadListener(Object tag, DownloadFinallyViewHolder holder) {
            super(tag);
            this.holder = holder;
        }
