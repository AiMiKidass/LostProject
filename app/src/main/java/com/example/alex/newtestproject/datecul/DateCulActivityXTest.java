...
import com.example.alex.newtestproject.test.XTestBaseActivity;
...
public class DateCulActivityXTest extends XTestBaseActivity {
...
//        mDutyDescArray.add("休息");
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(
                DateCulActivityXTest.this, android.R.layout.simple_list_item_1, mDutyDescArray);
